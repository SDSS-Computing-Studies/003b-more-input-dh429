...
adjective2 = ("Enter another adjective: ").strip()

noun1 = ("Enter a noun: ").strip()

place1 = ("Enter a place: ").strip()

verb1 = ("Enter a verb: ").strip()

adverb1 = ("Enter a adverb: ").strip()

food2 = ("Enter another name of a food: ").strip()

thing1 = ("Enter a thing: ").strip()
